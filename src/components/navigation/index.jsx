...
export default function WithSubnavigation() {
  ...
  return (
    ...
    >
      <Flex
        maxH={{ base: "20px", md: "100px" }} // Altura máxima ajustada
        bg={useColorModeValue("rgba(255, 255, 255, 0.8)", "rgba(0, 0, 0, 0.8)")}
        color={useColorModeValue("gray.600", "white")}
        minH={{ base: "50px", md: "60px" }} // Altura mínima ajustada
        py={{ base: 2, md: 4 }} // Padding vertical ajustado
        px={{ base: 3, md: 8 }} // Padding lateral ajustado
        borderBottom={1}
        borderStyle={"solid"}
